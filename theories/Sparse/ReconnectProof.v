...
Proof.
  ...
  - destruct sub as [|b sub']; [contradiction|].
    ...
    { apply (classified_sub_fixed
               [] (b :: sub') r
               (classify_spec_from_embedding [] (b :: sub') r
...
Proof.
  ...
  - assert (HoldLast : last_segment (l ++ sub ++ []) = last_segment sub).
    ...
    { apply (classified_sub_fixed
               l sub []
               (classify_spec_from_embedding l sub [] Hne Hmono Hsparse Hembedded Hext)).
...
Proof.
  ...
  - assert (HoldLast : last_segment (l ++ sub ++ []) = last_segment sub).
    ...
    { apply (classified_sub_fixed
               l sub []
               (classify_spec_from_embedding l sub [] Hne Hmono Hsparse
                  (ex_intro _ ds Hembed) Hext)).
      apply onSegmentlist_term_last. exact Hne. }
    exists p. split.
...
Proof.
  ...
  pose proof (classified_below_terminal_not_up
                l sub r
                (classify_spec_from_embedding l sub r Hne Hmono Hsparse Hembed Hext)
...
Proof.
  ...
  pose proof (classified_segment_endpoints_monotone
                l sub r
                (classify_spec_from_embedding l sub r Hne Hmono Hsparse Hembedded Hext)
