...
Proof.
  intros l sub r h old ordinary Hne Hconn Hmono Hsparse Hwhole
    Hold Hinit Hterm.
  unfold same_segment_box. split.
  - rewrite Hinit. symmetry. apply operate_sub_endpoint;
      try assumption.
    exists old. split; [exact Hold | now left].
  - rewrite Hterm. symmetry. apply operate_sub_endpoint;
      try assumption.
...
Proof.
  ...
  - exact (same_boxes_preserve_axis_separation
             ...
             (ordinary_sub_member_same_box
                l sub r h old_s ordinary_s Hsub Hconn Hmono Hsparse Hwhole
                HinsideS HinitS HtermS)
             (ordinary_sub_member_same_box
                l sub r h old_t ordinary_t Hsub Hconn Hmono Hsparse Hwhole
                HinsideT HinitT HtermT)
...
Proof.
  ...
  exact (classified_nonadjacent_endpoint_order
           l sub r
           (classify_spec_from_embedding l sub r Hsub Hmono Hsparse Hembed Hext)
...
Proof.
  ...
  { apply operate_sub_endpoint; try assumption. rewrite Hjoin.
